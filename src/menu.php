<form class="header-menu" method="get" action="films.php">
...
<form class="header-menu" method="get" action="serials.php">
...
<form class="header-menu" method="get" action="profile.php">
...
<form class="header-menu" method="get" action="index.php">
...
<form class="header-menu" method="get" action="extension.php">
